...
png(filename = here("4_Exploratory_Data_Analysis", "Week1", "plot3.png"), width = 480, height = 480, units = "px")

with(df, plot(Time, Sub_metering_1, type = "n", xlab = "", ylab = "Energy sub metering"))
with(df, lines(Time, Sub_metering_1, type = "l"))
